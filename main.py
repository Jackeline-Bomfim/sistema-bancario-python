...
class Conta:
    ...
    def depositar(self, valor):
        if valor > 0:
            ...
            print("Operação falour! O valor informado é inválido.")
            return False
...
def criar_cliente(clientes):
    ...
    data_nasicmento = input("Informe a data de nascimento(dd-mm-aaaa): ")
    endereco = input("Informe o endereço (logradouro, nro - bairro - cidade/sigla estado): ")

    cliente = PessoaFisica(nome=nome, data_nascimento=data_nasicmento, cpf=cpf, endereco=endereco)
...
def main():
    ...
    while True:
        ...
        if opcao == "1":
            ...
            print("Opção inválida, por gentileza selecione uma opção válida.")
